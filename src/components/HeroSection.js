    ...
    try {
      ...
      blockchain.smartContract.methods
        ...
        .then((receipt) => {
          setIsLoading(false);
          alert(
            "Congratulations! You have successfully minted your MustangDAO NFT. Check your transaction history to view it!"
          );
          ...
          <div className="btn-center">
            ...
            blockchain.smartContract === null ? (
              ...
              <div className="dropdown d-inline-flex align-items-center justify-content-center align-self-center flex-col space-y-4">
                <br />
                <br />
                <button type="button" className="btn w-full" onClick={() => mint(1)}>
                  Mint Your POAP!
                </button>
